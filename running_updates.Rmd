...
```{r mun.new, echo = FALSE, out.width = '100%'}
knitr::include_graphics("output/plots/plot_mun_new.png")
```

B. Microregion-level

```{r mic.new, echo = FALSE, out.width = '100%'}
knitr::include_graphics("output/plots/plot_mic_new.png")
```
...
### New Cases 
```{r boot.net, echo = FALSE, out.width = '100%'}
...
### Previous Cases
```{r boot.prev, echo = FALSE, out.width = '100%'}
